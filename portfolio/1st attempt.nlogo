...
turtles-own
  ...
  partner  ]          ;; The person that is our current partner in a couple.                ;; how many weeks old the turtle is
...
globals
  [ %infected            ;; what % of the population is infectious
    ...
    slider-check-4 ]  ;; how many weeks immunity lasts
